...
from calculator import calculator as calculatorClass
...
def consumer_list(request):
    ...
    return render(request, 'consumer/list.html', {
        'consumers': consumers,
...
def calculator(request):
    ...
    if request.method == 'POST':
        ...
        if distributor_tax is None or distributor_tax == "":
            ...
            return render(request, 'consumer/calculator.html', {'discount_rules': discount_rules})
