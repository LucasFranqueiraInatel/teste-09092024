# Generated by Django 4.2.11 on 2024-09-09 17:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumption_range', models.CharField(choices=[('<10000', 'Menor que 10.000 kWh'), ('10000-20000', 'Entre 10.000 e 20.000 kWh'), ('>20000', 'Maior que 20.000 kWh')], max_length=20, verbose_name='Faixa de Consumo')),
                ('cover_value', models.FloatField(verbose_name='Percentual de Cobertura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_rule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consumers', to='consumer.discountrule')),
            ],
        ),
    ]
